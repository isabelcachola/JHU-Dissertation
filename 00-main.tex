...
\usepackage[dvipsnames, table]{xcolor}             % color-related package
...
\include{front-matter/02-abstract}


%%%% OPTIONAL but COMMON: preface chapters
% \include{front-matter/03-dedication}
% \include{front-matter/04-acknowledgement}        
\include{front-matter/05-epigraph}
...
\include{front-matter/01-introduction}
\include{front-matter/02-background}

%%%% include all the main text chapters
\part{Generating Scientific Summaries with User Defined Attributes}\label{part1}
\include{research-chapters/3-chapter/0-main-chapter-3}
\include{research-chapters/4-chapter/0-main-chapter-4}
\part{Evaluating Scientific Summaries with User Parameters}\label{part2}
\include{research-chapters/5-chapter/0-main-chapter-5}
\include{research-chapters/6-chapter/0-main-chapter-6}
\include{research-chapters/7-chapter/0-main-chapter-7}
%% add more main text technical chapters if you have

\include{back-matter/0-conclusion}
...
\include{back-matter/1-chapter-appendix}
\include{back-matter/2-chapter-appendix}
\include{back-matter/3-chapter-appendix}
\include{back-matter/4-chapter-appendix}
\include{back-matter/5-chapter-appendix}
\include{back-matter/6-chapter-appendix}
\include{back-matter/7-chapter-appendix}
