...
For each annotation, given the degree of the preference $d$ (~\Cref{sec:annotation-instructions} Q. 2) we convert value to a score $P(d) \rightarrow [1,2,3]$ if $d$ is slight, moderate, or strong, respectively. 
