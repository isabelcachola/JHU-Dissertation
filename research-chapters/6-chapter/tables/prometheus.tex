...
\end{tabular}
\caption{%
  \textbf{Prometheus Eval on SummEval} across three evaluation settings.
  \colorbox{refbased}{\vphantom{x}Reference-based}: Gold references.
  ...
  \textbf{Bold} indicates the best score within each setting per column. Best traditional metrics from~\Cref{tab:traditional_metrics}.
}
