...
We begin with four different scientific summarization datasets: eLife~\cite{goldsack2022making}, Eureka~\cite{Zaman2020HTSSAN}, PLOS~\cite{goldsack2022making}, and SciNews~\cite{cardenas2024scinews}. These datasets are designed for  scientific PLS, allowing us to use the lay summary as the positive example and the abstract as the technical, negative example. 
