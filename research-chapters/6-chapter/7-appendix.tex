...
\section{SummEval Reproduction Study}\label{sec:6-appendix-summeval-repro}
...
\section{Prompts}\label{sec:6-chapter-prompts}
...
\section{Reference-Adjusted Evaluation on Traditional Metrics}\label{sec:6-appendix-trad-ref-eval}
...
\section{Additional Model Results}\label{sec:6-appendix-add-models}
