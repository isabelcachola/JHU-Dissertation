...
\toprule
\textbf{Metric} & \textbf{Ref.\ type} & \textbf{nrefs}
  & \textbf{Coherence} & \textbf{Consistency} & \textbf{Fluency} & \textbf{Relevance} \\
\midrule
\multicolumn{7}{l}{\textit{Reference-based}} \\ \midrule
\rowcolor{refbased}
...
\multicolumn{7}{l}{\textit{Reference-adjusted}} \\ \midrule
\rowcolor{refadj}
...
\midrule
\multicolumn{7}{l}{\textit{Reference-free}} \\ \midrule
\rowcolor{reffree}
...
\caption{%
  ...
  \colorbox{refbased}{\vphantom{x} Reference-based}: Gold (Standard) references.
