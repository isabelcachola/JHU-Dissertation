\chapter{Chapter 5 appendix} \label{chap:appendix-5}
...
\input{research-chapters/5-chapter/tables/prompt-comparison}
...
\section{Statistical Significance}\label{appendix:sig-testing}
...
\input{research-chapters/5-chapter/tables/prompts}
