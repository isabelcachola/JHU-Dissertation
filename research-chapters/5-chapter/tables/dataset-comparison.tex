...
\end{tabular}
\caption{Comparison of the datasets analyzed in this paper. The first 4 are datasets in with a specific target audience. The following 6 datasets are commonly used in PLS literature. We report the number of documents (\# Docs) in the test set as well as the average number of tokens (\# Tokens).
