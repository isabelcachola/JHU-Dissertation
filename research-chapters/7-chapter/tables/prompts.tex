...
\bottomrule
\end{tabular}
\caption{Prompt template for LLM Judges. Score rubrics in~\Cref{tab:ch-7-llm-judge-rubrics}. Source is also provided in prompt for consistency and relevance.}\label{tab:ch-7-prompt-llm-judge}
\end{table}
...
\bottomrule
\end{tabular}
\caption{Score rubrics for prompt in~\Cref{tab:ch-7-prompt-llm-judge}.}\label{tab:ch-7-llm-judge-rubrics}
\end{table*}
...
\bottomrule
\end{tabular}
\caption{Prompt template for LLM Judge Annotator, in which the prompt reflects the instructions given to the human annotators.}\label{tab:ch-7-prompt-llm-judge-annotator}
\end{table}
...
\bottomrule
\end{tabular}
\caption{Prompts for the synthetic perturbations tests, described in~\Cref{sec:ch-7-experimental-setup}.}\label{tab:ch-7-perturbation-prompts}
\end{table}