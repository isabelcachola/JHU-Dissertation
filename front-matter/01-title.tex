...
\ThesisTitle{Methods for the generation and evaluation of user-centric scientific summarization}

\vspace{1in}                    % gap between the title and the author: approx. 1 inch

\ThesisAuthor{Isabel Cachola}         % author name for the thesis
...
\ThesisDate{May}{2026}        % thesis submission month and year (single-spaced)
...
\ThesisCopyright{2026}{Isabel Cachola}
