\section{Perturbation Testing Results \hyperref[chsevenrq1]{\chsevenrqone}}
...
\begin{figure*}[htbp]
    ...
    \end{subfigure}
    \caption{Visualization of how non-LLM-based metrics react to the 5 perturbation tests outlines in~\Cref{sec:ch-7-experimental-setup}.}
...
\begin{figure*}[htbp]
    ...
    \end{subfigure}
    \caption{Visualization of how LLM-based metrics react to the 5 perturbation tests outlined in~\Cref{sec:ch-7-experimental-setup}. Scores are normalized to the same range for comparative visualization. }
