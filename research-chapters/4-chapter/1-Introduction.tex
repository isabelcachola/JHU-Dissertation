...
Our work clarifies the data requirements for control vectors, increasing the chance of future success for new tasks. We release our inference code and dataset splits to support future work.\footnote{\url{https://github.com/JHU-CLSP/control-summ}}
