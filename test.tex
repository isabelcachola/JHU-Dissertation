...
\centering
    \begin{subtable}{.9\textwidth}
        ...
        % OLMo 2 13 B & \cellcolor[HTML]{B7E1CD}1.81E-04 & \cellcolor[HTML]{B7E1CD}0.01 & \cellcolor[HTML]{B7E1CD}0.02 & \cellcolor[HTML]{B7E1CD}3.75E-03 & \cellcolor[HTML]{B7E1CD}0.02 & 0.11 & 0.11 & \cellcolor[HTML]{B7E1CD}0.01
        \end{tabular}
    ...
    \begin{subtable}[t]{.9\textwidth}
        ...
        % OLMo 2 13 B & \cellcolor[HTML]{B7E1CD}3.15E-03 & \cellcolor[HTML]{B7E1CD}0.01 & \cellcolor[HTML]{B7E1CD}0.02 & \cellcolor[HTML]{B7E1CD}0.01 & \cellcolor[HTML]{B7E1CD}0.03 & 0.10 & 0.08 & \cellcolor[HTML]{B7E1CD}0.02
        \end{tabular}
        \caption{Kendall-Tau p-values.}\label{subtab:kt-pval}
    \end{subtable} 
    \caption{William's test p-values comparing the difference in performance between each LM and each traditional metric. Values that are statistically significant ($\textrm{p-value} < 0.05$), are highlighted in green.}
    \label{tab:signigicance-testing}
\end{table}
\end{document}