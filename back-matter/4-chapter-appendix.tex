...
The number of shots provided to for In-Context Learning does not have a significant effect on the overall controllability or quality of the summaries. Therefore, to save compute by number of tokens, we use $N=1$ for the ICL experiments in the main body of results, reported in~\Cref{sec:results}.
