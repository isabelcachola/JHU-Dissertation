...
\end{tabular}
\caption{The mean score (S) and rank (R) for each dataset, as judged by an LM evaluator and FKGL. $\Delta$R represents the change in rank from the LM evaluator to the FKGL scores.}\label{tab:ranked-datasets}
\end{table}