...
We experiment with the following 5 LMs as evaluators of readability: Mistral 7B~\cite{Jiang2023Mistral7}, Mixtral 7B~\cite{jiang2024mixtral}, Gemma 7B~\cite{gemma_2024}, Llama 3.1 8B, and Llama 3.3 70B~\cite{dubey2024llama3herdmodels}. We experiment with 3 prompts and report the prompts in \cref{appendix:prompt}. We report the Pearson and Kendall-Tau correlations of the scores provided by each LM with the human judgments.
