...
\centering
    ...
    \end{subtable} 
    % \vspace{-2mm}
    \caption{Examples of disagreement between FKGL and the LM evaluator. \ref{subtab:ex-disaggreement-sjk} contains an example from the SJK dataset that the LM rated high readability and FKGL rated low readability. \ref{subtab:ex-disaggreement-plos} contains a summary from the Pubmed dataset that the LM rated low readability while FKGL rated high readability.}\vspace{-4mm}
