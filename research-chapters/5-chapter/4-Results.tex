...
%Below is a summary of the results from the experiments described in \S\ref{sec:experimental-setup}. 



\begin{figure}[t]
    \centering
    \includegraphics[width=0.99\linewidth]{research-chapters/5-chapter/figures/count_acl_eval.pdf}
    \vspace{-5mm}
    \caption{Evaluation metrics used by papers published in the ACL Anthology. We report the count of papers using each method out of a total of 18 papers. We additionally report the evaluation strategies used by PLS shared tasks and the number of participants.}
    \label{fig:lit-survey-results}
    \vspace{-4mm}
\end{figure}
\section{Results}\label{sec:results}

\subsection{Current PLS evaluation standards \hyperref[rq1]{\rqone}}\label{subsec:results-rqone}
...
\subsection{Comparing traditional readability metrics to human judgments \hyperref[rq2]{\rqtwo}}\label{subsec:results-rqtwo}
...
\input{research-chapters/5-chapter/tables/human_correlation}


\input{research-chapters/5-chapter/tables/summ-examples}
\begin{figure}[t]
    \centering
    \vspace{-2mm}
...
\subsection{LMs as evaluators of readability \hyperref[rq3]{\rqthree}}\label{subsec:results-rqthree}
...
\centering\includegraphics[width=.99\textwidth]{research-chapters/5-chapter/figures/lm_readability-scores.pdf}
    \vspace{-3mm}
    \caption{Histogram of LM readability scores and the mean scores ($\mu$) for each dataset, as judged by \texttt{Llama 3.3 70B}. As we can see from the results, PLOS and CELLS are judged to be similarly readable to the expert targets datasets (arXiv, PubMed, and SciTLDR). The most readable PLS datasets are CDSR and SciNews.}
    \vspace{-4mm}
    \label{fig:histogram-datasets}
\end{figure*}


\input{research-chapters/5-chapter/tables/lm-readability-scores-by-dataset}
\subsection{Analysis of summarization datasets \hyperref[rq4]{\rqfour}}\label{subsec:results-rqfour}
...
\begin{figure}[!h]
    ...
    \caption{Keywords mentioned in the reasoning of the LM evaluator for why a summary was given a certain readability score. \Cref{fig:keywords-score} contains the keywords stratified by score and \Cref{fig:keywords-dataset} contains keywords stratified by dataset.}
...
\input{research-chapters/5-chapter/tables/ranked-datasets}

\input{research-chapters/5-chapter/tables/disagreement-example}
